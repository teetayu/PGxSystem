...
const reportData = [
    ...
    { no: 2, fullName: "นายเทส ทดสอบ", hn: "HN000011", status: "รอดำเนินการ", genotype: "VKORC1" },
    { no: 3, fullName: "นายเทส ทดสอบ", hn: "HN000011", status: "รอดำเนินการ", genotype: "VKORC1" }
];
...
function editRow(no) {
    ...
    window.location.href = `MedicalTechPatient.html?id=${no}`;
}

// เมื่อกดปุ่ม “เลือก”
function selectRow(no) {
    window.location.href = `ReportDetail.html?id=${no}`;
}
